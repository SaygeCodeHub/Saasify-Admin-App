...
void setupServiceLocator() {
  ...
  getIt.registerSingleton<ProductsModel>(ProductsModel());
  getIt.registerSingleton<BillDetails>(BillDetails());
  getIt.registerSingleton<ProductVariant>(ProductVariant());
}
