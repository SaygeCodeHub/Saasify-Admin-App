...
class HiveDataScreenState extends State<HiveDataScreen> {
  ...
  void deleteAllDataFromHive() async {
    ...
    print('All data has been deleted from the specified Hive boxes.');
  }
}
